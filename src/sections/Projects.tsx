...
export default function Projects() {
  ...
  return (
    <div id="projects" className="bg-(--dark) text-(--light) flex flex-col justify-center items-center py-10 transition-all ">
      ...
      <div
        className="flex flex-row overflow-x-auto overflow-visible no-scrollbar gap-5 sm:gap-10 w-full p-5 sm:py-10 transition duration-500">
            {
              projects?.map((project)=>
              <div
              key={project._id}
              className="min-w-[320px] sm:min-w-100 lg:min-w-150 flex justify-center items-center transition-all duration-500 ">
